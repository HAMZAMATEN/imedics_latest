...
class CallEndScreen extends StatelessWidget {
  ...
  CallEndScreen({super.key,required this.doctor,
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.alarm,size: 50.sp,color: Colors.black54,),
                  SizedBox(height: 30.h,),
                  Text("The Consultation Session has ended",
                    textAlign: TextAlign.center,
                    style: getSemiBoldStyle(color: Colors.white,fontSize: MyFonts.size30),),
                  SizedBox(height: 30.h,),
                  CustomButton(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Text("Consultation Session with ${doctor.name}",
                        textAlign: TextAlign.center,
                        style: getSemiBoldStyle(color: Colors.white,fontSize: MyFonts.size18),),
                      padding5,
                      Text("${doctor.specialization}",
                        textAlign: TextAlign.center,
                        style: getSemiBoldStyle(color: Colors.white,fontSize: MyFonts.size16),),
